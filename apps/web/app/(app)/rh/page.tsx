...
import { EditPersonPanel } from "./_components/edit-person-panel";
              ...
              {people.map((person) => {
                ...
                return (
                  <tr key={person.personId} className="border-b border-border last:border-none">
                      ...
                      <div className="flex flex-col gap-2">
                        {active.map((a) => (
                          <div key={a.id} className="flex flex-wrap items-center gap-1.5">
                            ...
                            <StatusControl personId={person.personId} affectationId={a.id} currentStatus={a.status} />
                          </div>
                        ))}
                    ...
                    <td className="px-4 py-3">
                      <EditPersonPanel personId={person.personId} />
                    </td>
                  </tr>
                );
              })}
